...
public class PickImageFragment extends Fragment {
    ...
    private static final int IMAGE_PICKER_REQUEST = 981;
...
//        options.inSampleSize = 2;
    ...
    private Bitmap getBitmapMemoryValidation(Uri selectedimg) throws IOException {
        AssetFileDescriptor fileDescriptor = getActivity().getContentResolver().openAssetFileDescriptor(selectedimg, "r");
        ...
        final int pixels = height * width;
        final int bytes = pixels * Utils.getBytesPerPixel(Bitmap.Config.RGB_565);
        ...
        Log.i("MEMORY", "Image Bytes:   " + bytes);
        Log.i("MEMORY", "Max Memory:    " + maxMemory);
        Log.i("MEMORY", "Free Memory:   " + freeMemory);
        Log.i("MEMORY", "Total Memory:  " + totalMemory);
...
//        }
        ...
        Bitmap bitmap = decodeFileDescriptor(fileDescriptor.getFileDescriptor(), null, options);
