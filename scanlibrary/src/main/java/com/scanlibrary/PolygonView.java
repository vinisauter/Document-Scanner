...
class PolygonView extends FrameLayout {
    ...
    private OnCircleTouch onCircleTouch = null;
    ...
    public void setOnCircleTouch(OnCircleTouch onCircleTouch) {
        this.onCircleTouch = onCircleTouch;
    }
...
//        LayoutParams layoutParams = new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        int size = getResources().getDimensionPixelSize(R.dimen.polygonViewCircleWidth);
...
//            if (onCircleTouch != null) {
//                onCircleTouch.onTouch(v, event);
//            }
            return true;
        }
    }
