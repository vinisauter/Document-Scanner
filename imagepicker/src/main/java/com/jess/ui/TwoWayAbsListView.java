...
//	//}
    ...
    public void reclaimViews(List<View> views) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            TwoWayAbsListView.LayoutParams lp = TwoWayAbsListView.LayoutParams.cast(child.getLayoutParams());
    ...
    public static class LayoutParams extends ViewGroup.LayoutParams {
        ...
        public static LayoutParams cast(ViewGroup.LayoutParams layoutParams) {
    ...
    class RecycleBin {
        ...
        void addScrapView(View scrap) {
            TwoWayAbsListView.LayoutParams lp = TwoWayAbsListView.LayoutParams.cast(scrap.getLayoutParams());
            if (lp == null) {
                return;
            }
        ...
        void scrapActiveViews() {
            ...
            for (int i = count - 1; i >= 0; i--) {
                ...
                if (victim != null) {
                    int whichScrap = (TwoWayAbsListView.LayoutParams.cast(victim.getLayoutParams()).viewType);
